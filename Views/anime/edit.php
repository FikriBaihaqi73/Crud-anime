...
<head>
    ...
    <link rel="stylesheet" href="/tugasakhir1/Public/css/form-style.css">

</head>
<body>
    <div id="Container">        <h1>Edit Anime</h1>
            <form class="anime-form"method="POST" action="/tugasakhir1/Public/index.php?action=edit&id=<?= $anime['id']; ?>">
            <div id="form-label">Edit Anime</div>
            <input class="form-input" type="text" name="nama" value="<?= $anime['nama']; ?>" placeholder="Nama Anime" required>
            <input class="form-input" type="number" name="tahun" value="<?= $anime['tahun']; ?>" placeholder="Tahun" required>
            <input class="form-input" type="text" name="studio" value="<?= $anime['studio']; ?>" placeholder="Studio" required>
            <input class="form-input" type="text" name="mangaka" value="<?= $anime['mangaka']; ?>" placeholder="Mangaka" required>
            <input class="form-input" type="text" name="genre" value="<?= $anime['genre']; ?>" placeholder="Genre" required>
            <button type="submit" class="form-button">Update</button>
            <a href="/tugasakhir1/Public/index.php?action=index" class="form-button-cancel">Batal</a>
        </form>
