...
<body>
    <div id="Container">
        <form class="anime-form" method="POST" action="/tugasakhir1/Public/index.php?action=create">
            <div id="form-label">Tambah Anime</div>
            <input class="form-input" type="text" name="nama" placeholder="Nama Anime" required>
            <input class="form-input" type="number" name="tahun" placeholder="Tahun" required>
            <input class="form-input" type="text" name="studio" placeholder="Studio" required>
            <input class="form-input" type="text" name="mangaka" placeholder="Mangaka" required>
            <input class="form-input" type="text" name="genre" placeholder="Genre" required>
